...
class ImageClassification:
    ...
    def Test_All_Models_For_True_Accuracy(self):
        namePart1 = "models/effnet_un_FT__"
        namePart2 = "kfoldcp"
        namePart3 = ".ckpt"
    ...
    def Test_Bad_Models_For_True_Accuracy(self):
        name = "models/myModelcp1.ckpt"

        ctAll = 0
        ctCorrect = 0
        ctWrong = 0
        ctSemi = 0
        self._my_model.load_weights(name)
        print("\nName: " + name + "\n")
        for img in os.listdir(self._all_photos_test_path):
            img_name = img
            img = image.load_img(self._all_photos_test_path + "/" + img, target_size=IMAGE_SIZE)
...
if __name__ == '__main__':
    while True:
        ...
        if mode == 1:
            ...
            ic.Test_Bad_Models_For_True_Accuracy()
        elif mode == 0:
            break
